...
$lang = array_merge($lang, array(
    ...
    'ACP_PHPBBLAB_PORTAL_AS_HOMEPAGE_EXPLAIN'     => 'Enabled by default. A visit to the board root (for example https://example.com/) is redirected to the portal. index.php remains the normal forum index. Only GET and HEAD requests are redirected.',
