...
- Optional use of the portal as the board home page with a permanent, session-ID-free redirect from the bare board root.
- Self-referencing canonical URL on the public portal page.
